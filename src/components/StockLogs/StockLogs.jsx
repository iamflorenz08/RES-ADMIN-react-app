...
const StockLogs = ({setActive}) => {
    ...
    useEffect(() => {
        const loadTable = async() => {
            let stock_logs = await axios.get(`${baseURL}/log/stock/1/10`)
                    ...
                    <div className="box col-start-1 col-end-1 row-start-1 row-end-1">
                        <div>
                            ...
                            <div
                                ...
                                {/* <!-- generate report btn --> */}
                                <button data-modal-toggle="stocklogs-genReport" type="button"
                            ...
                            <div>
                                ...
                                {/* <!-- MODAL AREA --> */}
                                <div id="stocklogs-genReport" tabIndex="-1" aria-hidden="true"
                                ...
                                <div className="bg-grey-50 mx-6 mt-2 mb-1 flex items-center justify-between">
                                    ...
                                    <span className="text-sm text-gray-700 dark:text-gray-400">
                                        Showing
                                        <span className="font-bold text-gray-900 dark:text-gray-900"> 1 - 8 </span>
                                        out of
                                        <span className="font-bold text-gray-900 dark:text-gray-900"> 10 </span>
                                        Logs
                                    </span>
