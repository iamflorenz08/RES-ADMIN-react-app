...
const DeleteEmployeeModal = ({ isToggle, setToggle, user_id, setRefreshKey }) => {
    const baseURL = process.env.REACT_APP_API

    const deleteEmployee = () => {
        axios.delete(baseURL + '/user?user_id=' + user_id)
            .then(response => {
    ...
    return (
        isToggle && (
            < div id="stock-del" tabIndex="-1"
                ...
                <div className="fixed inset-0 bg-black z-auto opacity-75" onClick={() => setToggle(null)}>
                </div>
                <div className="relative h-full w-full max-w-md md:h-auto">
                    <div className="relative rounded-lg bg-white shadow">
                        <div className="p-6 text-center">
                            ...
                            <h2 className="font-bold text-black">DELETE EMPLOYEE</h2>
                            <h3 className="mb-5 text-lg font-normal text-gray-700 dark:text-gray-700">
                                Are you sure you want to delete this employee?</h3>
